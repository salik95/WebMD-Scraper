...
with open('WebMD 56-60.tsv') as conditions:
...
condition_outfile = open('condition 12.csv', 'w')
...
treatment_outfile = open('treatment 12.csv', 'w')
...
review_outfile = open('review 12.csv', 'w')
