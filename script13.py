...
with open('WebMD 61-65.tsv') as conditions:
...
condition_outfile = open('condition 13csv', 'w')
...
treatment_outfile = open('treatment 13.csv', 'w')
...
review_outfile = open('review 13.csv', 'w')
